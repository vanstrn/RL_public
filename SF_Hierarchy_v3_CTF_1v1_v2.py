...
def UseSubpolicy(s,subpolicyNum):
    ...
    if locX+1 > s0.shape[1]-1:
        actionValue.append(-999)
    elif [0,int(locX+1),int(locY),3] == 1:
        actionValue.append(-999)
    else:
        actionValue.append(options[int(subpolicyNum)][int(locX+1),int(locY),int(locX2),int(locY2)  ]) # Go Up

    if locY+1 > s0.shape[2]-1:
        actionValue.append(-999)
    elif [0,int(locX),int(locY+1),3] == 1:
        actionValue.append(-999)
    else:
        actionValue.append(options[int(subpolicyNum)][int(locX),int(locY+1),int(locX2),int(locY2)    ]) # Go Right
    ...
    if locY-1 < 0:
        ...
        actionValue.append(options[int(subpolicyNum)][int(locX-1),int(locY),int(locX2),int(locY2)  ]) # Go Down
    ...
    if locY-1<0:
        ...
        actionValue.append(options[int(subpolicyNum)][int(locX),int(locY-1),int(locX2),int(locY2)    ]) # Go Left
