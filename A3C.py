...
class Worker(threading.Thread):
  ...
  def __init__(self,
    ...
    self.opt = opt
    self.local_model = ActorCritic_CNN(self.state_size, self.action_size)
    self.worker_idx = idx
  ...
  def run(self):
    ...
    while Worker.global_episode < args.max_eps:
      current_state = self.env.reset(policy_red=Roomba())
      mem.clear()
      ep_reward = 0.
      ep_steps = 0
      self.ep_loss = 0
