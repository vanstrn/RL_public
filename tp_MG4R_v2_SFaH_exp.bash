...
python SF_v2_action.py -f MG4R_v2_SFa.json -c '{"RunName":"MG4R_v2_SFa_128_'$1'"}' -n '{"DefaultParams":{"SFSize":"128"}}' -p /$DEVICE:0
...
python SF_v2_action.py -f MG4R_v2_SFa.json -c '{"RunName":"MG4R_v2_SFa_96_'$1'"}' -n '{"DefaultParams":{"SFSize":"96"}}' -p /$DEVICE:0
...
python SF_v2_action.py -f MG4R_v2_SFa.json -c '{"RunName":"MG4R_v2_SFa_64_'$1'"}' -n '{"DefaultParams":{"SFSize":"64"}}' -p /$DEVICE:0
...
python SF_v2_action.py -f MG4R_v2_SFa.json -c '{"RunName":"MG4R_v2_SFa_48_'$1'"}' -n '{"DefaultParams":{"SFSize":"48"}}' -p /$DEVICE:0
